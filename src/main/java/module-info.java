...
/*module com.aysekarapinar.ibb_ecodation_javafx {
    ...
    opens com.aysekarapinar.ibb_ecodation_javafx.dto to javafx.base, lombok;

    // Controller sınıfları FXML tarafından kullanılacağı için açılması gerekiyor.
    opens com.aysekarapinar.ibb_ecodation_javafx.controller to javafx.fxml;

    // DAO (Data Access Object) sınıfları, SQL bağlantısı kullandığı için açılıyor.
    opens com.aysekarapinar.ibb_ecodation_javafx.dao to java.sql;

    // Veritabanı bağlantısı sağlayan sınıfların da SQL modülüne açık olması gerekiyor.
    opens com.aysekarapinar.ibb_ecodation_javafx.database to java.sql;
