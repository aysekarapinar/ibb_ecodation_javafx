...
public class _15_3_LocaleDateTime {
    ...
    public static void localDateFormatSetMethod(){
        Locale locale=new Locale("TR", "tr");
        ...
        System.out.println("Değiştirilmiş Tarih: "+newDate.format(formatter));
    }

    public static void main(String[] args) {
        localDateFormatGetMethod1();
        localDateFormatGetMethod2();
        localDateFormatSetMethod();
    }
}
