package com.aysekarapinar.ibb_ecodation_javafx.tutorials.common;

public class _21_1_Exception {
    // Exception: try, catch, finally, throws, throw
    // PSVM
    public static void main(String[] args) throws ArithmeticException, IndexOutOfBoundsException, AyseKarapinarException {
        ...
        throw new AyseKarapinarException(" burada bilerek istisna oluşturdum.");
