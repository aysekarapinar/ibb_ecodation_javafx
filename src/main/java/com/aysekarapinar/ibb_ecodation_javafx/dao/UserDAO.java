...
import com.aysekarapinar.ibb_ecodation_javafx.database.SingletonPropertiesDBConnection;
...
public class UserDAO implements IDaoImplements<UserDTO>, ILogin<UserDTO> {
    ...
    public boolean verifyUser(String email, String currentPassword) {
        ...
        try (Connection conn = DbConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                return util.BCryptUtil.checkPassword(currentPassword, hashedPassword);
            }
    ...
    public void changePassword(String email, String newPassword) {
        ...
        try (Connection conn = DbConnection.getConnection();
            ...
            String hashedNewPassword = util.BCryptUtil.hashPassword(newPassword);
