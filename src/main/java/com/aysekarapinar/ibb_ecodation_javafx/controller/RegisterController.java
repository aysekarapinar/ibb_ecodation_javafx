...
import com.aysekarapinar.ibb_ecodation_javafx.utils.SpecialColor;
...
public class RegisterController {
    ...
    private void switchToLoginPane() {
        try {
            ...
            System.out.println(SpecialColour.RED + "Login Sayfasına yönlendirme başarısız" + SpecialColour.RESET);
            e.printStackTrace();
