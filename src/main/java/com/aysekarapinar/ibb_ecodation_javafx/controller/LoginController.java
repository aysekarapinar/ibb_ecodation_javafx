...
import com.aysekarapinar.ibb_ecodation_javafx.utils.ERole;
import com.aysekarapinar.ibb_ecodation_javafx.utils.FXMLPath;
import com.aysekarapinar.ibb_ecodation_javafx.utils.SceneHelper;
...
public class LoginController {
    ...
    private void openUserHomePane() {
        try {
            ...
            System.out.println(SpecialColour.RED + "Kullanıcı paneline yönlendirme başarısız" + SpecialColour.RESET);
            e.printStackTrace();
    ...
    private void openAdminPane() {
        try {
            ...
            System.out.println(SpecialColour.RED + "Admin Sayfasına yönlendirme başarısız" + SpecialColour.RESET);
            e.printStackTrace();
    ...
    private void switchToRegister(ActionEvent actionEvent) {
        try {
            ...
            System.out.println(SpecialColour.RED + "Register Sayfasına yönlendirme başarısız" + SpecialColour.RESET);
            e.printStackTrace();
